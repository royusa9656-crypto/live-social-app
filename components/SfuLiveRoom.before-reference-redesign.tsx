  ...
  >
      ...
      >
        ...
        <View
          style={{
            ...
            paddingLeft: 12,
            borderRadius: 14,
            backgroundColor: 'rgba(255,24,135,0.16)',
            borderLeftWidth: 2,
            borderLeftColor: '#ff1687',
          }}
        >
          <Text
            style={{
          ...
          >
            HOST  <Text style={{ color: '#ff4ba8' }}>0</Text>
          </Text>
        </View>
        ...
        <View
          style={{
            ...
            marginTop: 7,
            borderRadius: 18,
            backgroundColor: 'rgba(18,18,27,0.98)',
            borderWidth: 1,
        ...
        <View
          style={{
            ...
            paddingRight: 12,
            borderRadius: 14,
            backgroundColor: 'rgba(39,137,246,0.16)',
            borderRightWidth: 2,
            borderRightColor: '#2789f6',
          }}
        >
          <Text
            style={{
          ...
          >
            <Text style={{ color: '#58a6ff' }}>0</Text>  OPPONENT
          </Text>
        </View>
      </View>
    ...
    >
      ...
      >
        <View
          style={{
            ...
            height: 38,
            borderRadius: 19,
            backgroundColor: 'rgba(53,141,242,0.22)',
            borderWidth: 1,
        ...
        <View
          style={{
            ...
            borderRadius: 19,
            marginLeft: -8,
            backgroundColor: 'rgba(132,98,239,0.22)',
            borderWidth: 1,
            borderColor: 'rgba(255,255,255,0.55)',
          }}
        />
      ...
      >
        ...
        >
          Invite someone to join the battle
        </Text>
      </View>
    </View>
    ...
    >
      <Text
        style={{
          ...
          textShadowColor: 'rgba(255,30,145,0.28)',
      ...
      >
        ...
        <Text
          style={{
            color: '#5b9cff',
            textShadowColor: 'rgba(70,145,255,0.30)',
            textShadowOffset: { width: 0, height: 3 },
            textShadowRadius: 8,
          }}
        >
      ...
      {['♡', '🌹', '🎁', '↗'].map((icon) => (
        <Pressable
          ...
          style={{
            ...
            borderRadius: 26,
            marginLeft: 7,
            backgroundColor: 'rgba(28,28,35,0.96)',
            borderWidth: 1,
            borderColor: 'rgba(255,255,255,0.13)',
            alignItems: 'center',
            justifyContent: 'center',
