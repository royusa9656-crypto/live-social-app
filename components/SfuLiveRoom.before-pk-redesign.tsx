  ...
  >
    ...
    >
      <View
        style={{
          flex:1,
          backgroundColor:'#120c16',
          borderWidth:1,
          borderColor:'rgba(255,58,150,.7)',
          borderRadius:10,
          overflow:'hidden',
        }}
      >
      ...
      >
        ...
        >
          Invite a LIVE host to start PK
        </Text>
      </View>
    ...
    >
      <View
        style={{
          ...
          paddingVertical:9,
          borderRadius:20,
          backgroundColor:'rgba(255,25,136,.16)',
          borderWidth:1,
          borderColor:'rgba(255,25,136,.45)',
        }}
      >
        <Text
          style={{
