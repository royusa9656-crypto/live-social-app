...
function RoomGrid({ role, onClose }:{role:'host'|'guest';onClose:()=>void}) {
  ...
  return <View style={styles.room}>
    <View style={styles.header}><Text style={styles.live}>● LIVE</Text><Text style={styles.roomText}>PK-TEST-123 · {room.name} · {role.toUpperCase()}</Text><Pressable onPress={onClose}><Text style={styles.close}>×</Text></Pressable></View>
